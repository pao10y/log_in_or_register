...
# initialize a cart list, for the user to add a product into the cart
cart = []
...
def view_cart():
    ...
    for idx, item in enumerate(cart):
        print("\tItem {}: {}".format(idx + 1, item[1]))
    ...
    while True:
        ...
        if admin_or_user == 1:
            while True:
                ...
                print("7. Log-out")
                choice = input("To execute a command, please enter the number:")
                if choice == '1':
                    Add_product()
                elif choice == '2':
                    delete_product()
            ...
            while True:
                ...
                print("2. View cart")
                print("3. Delete cart")
                # other customer methods will be added here
                choice = input("To execute a command, please enter the number: ")
                if choice == '1':
                    add_to_cart()
                elif choice == '2':
